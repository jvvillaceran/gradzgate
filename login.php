...
<html>
	...
	<body>
			<nav class="navbar navbar-inverse bg-inverse navbar-toggleable-md">
		        ...
		        <a class="navbar-brand" href="index.php" style="font-family: Century Gothic;">
			    	<img src="assets/134.svg" width="50" height="50" class="d-inline-block align-center" alt=""></img>
			    	gradzgate
		  		</a>
	    	...
	    	<div class="card mx-auto" style="width: 30rem;">
				...
				<h6 class="form-signin-heading card-header">Please sign in</h6>
				<div class="card-block" >
					...
					<form class="form-signin smallfont" method = "POST">
				        ...
				        <div class="card mx-auto" style="width: 20rem;">
				        	<button class="btn btn-md btn-default smallfont" type="submit" formaction = "loginprocess.php">Sign in</button>
				        </div>
      				</form>
				</div>	    		
	    	</div>
				...
				<div class="row card-inverse smallfont" style="background-color:#000000;">
					<div class="">
						<div class="d-inline-flex justify-content-center p-2 smallfont"><img src="assets/brand.png" width="8%" height="8%" >
							<div class="d-inline-flex justify-content-end p-2"><a href="">Terms</a></div>
							...
							<div class="d-inline-flex justify-content-end p-2"><a href="">Advertise</a></div>
