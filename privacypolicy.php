...
<html>
	...
	<body>
	    	...
	    	<div class="card mx-auto mb-4" style="width: 60rem;">

				<h4 class="card-header">Your Privacy Matters</h4>

				<div class="card-block mediumfont" >
					
					<p>At gradzgate, our fundamental philosophy is “members first.” That value powers all of the decisions we make, including how we gather and respect your personal information
					<br><br></p>
