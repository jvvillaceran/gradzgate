	...
	<body>
			<nav class="navbar navbar-inverse bg-inverse navbar-toggleable-md" style="border-bottom: 4px solid #025AA5; ">
				...
				<form class="form-inline my-2 my-lg-0">
			      ...
			      <label class="mr-sm-2 whitefont cfont" for="inlineFormCustomSelect">Jayvee Villaceran</label>
	    	...
	    	<div class="container">
	    		...
	    		<div class="row">
	    			...
	    			<div class="col-md-3 mb-3">
		    				...
		    				<div class="card">
							    ...
							    <div class="text-center" style="margin-top:-70px; ">
							      ...
							      <h5 class="card-title text-center">Jayvee Villaceran</h5>

								      <p class="smallfont">Controls</p>
								      <!-- BULLETIN MODULES HERE -->
	    					...
	    					<div class="card">
	    					<h6 class="card-header">Sponsored</h6>
							  <div class="p-3">
	    			...
	    			<div class="col-md-9 mb-3">
	    				...
	    				<div class="card">
	    					<h5 class="card-header">Jobs Bulletin</h5>
	    					<div class="card-block">
